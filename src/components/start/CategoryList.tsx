...
/**
 * SCR-05 element 7 — in `ENT-02.position` order (DEV-01: the real seeded categories and counts). A
 * row starts a session for its category (API-10), so it submits a form rather than following a link.
 */
    ...
    <section>
      ...
      <List>
        {categories.map((category) => (
          <form key={category.id} action={startSessionAction}>
